...
class IndonesianPackages {
  ...
  static final List<Question> _package1Questions = [
    const Question(
      ...
      question: 'Gagasan pokok paragraf tersebut adalah ...',
      options: {
    ...
    const Question(
      id: 2,
      question: 'Kata "masif" dalam paragraf tersebut bermakna ...',
      options: {
    ...
    const Question(
      id: 4,
      question: 'Penulisan kata serapan yang benar terdapat pada kalimat ...',
      options: {
    ...
    const Question(
      id: 5,
      question: 'Kalimat efektif terdapat pada ...',
      options: {
  ...
  static final List<Question> _package4Questions = [
    const Question(
      id: 1,
      question: 'Kalimat yang menggunakan kata baku dengan tepat adalah ...',
      options: {
  ...
  static final List<Question> _package5Questions = [
    const Question(
      id: 1,
      question: 'Kata "resistensi" bermakna ...',
      options: {
        'A': 'Dukungan',
